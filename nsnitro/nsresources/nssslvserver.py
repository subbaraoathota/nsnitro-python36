...
class NSSSLVServer(NSBaseResource):
    ...
    def get_sslprofile(self):
        return self.options['sslprofile']

    def set_sslprofile(self, sslprofile):
        self.options['sslprofile'] = sslprofile
    ...
    def update(nitro, sslvserver):
        ...
        __sslvserver.set_sslprofile(sslvserver.get_sslprofile())
